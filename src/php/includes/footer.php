            ...
            <div class="col-span-12 md:col-span-8 md:col-start-3 lg:col-span-6 lg:col-start-4">
               <div class="flex flex-col justify-center items-center text-center">
                  <div class="flex items-center justify-center mb-6">
                        <div>
                           <a class="font-black text-3xl" href="#"> WO.pik </a>
                        </div>
                        <div>
                           <p class="pl-3">&#169; Copyright all rights reserved</p>
                        </div>
                  </div>
                  <p class="opacity-75 mb-6">
                        Bersama WO.pik, setiap persiapan pernikahan jadi lebih mudah. Kami siap mendampingi dari awal hingga akhir, agar hari bahagiamu berjalan lancar dan penuh kenangan.
                  </p>
